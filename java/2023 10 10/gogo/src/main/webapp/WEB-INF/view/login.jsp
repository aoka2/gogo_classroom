...
<div class="center">
<form action="Login" name="loginSubmit" method="post">

<label class="form-margin textbox-003-label" for="name">名前</label><br>
<input class="textbox-003" type="text" name="name" required><br>

<label for="pass" class="form-margin textbox-003-label">パスワード</label>
<input type="password" class="textbox-003" id="pass" name="HashFlont"><br>

<input type="hidden"id="hashPass" name="pass">
<input type="button" class="button-030" onclick="Hash()" value="ログイン">
</form>
